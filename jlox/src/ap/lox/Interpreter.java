...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitCallExpr(Expr.Call expr) {
        ...
        if (!(callee instanceof LoxCallable)) {
            throw new RuntimeError(expr.parent, "Can only call functions and classes.");
        }

        LoxCallable function = (LoxCallable)callee;

        if (arguments.size() != function.arity()) {
            throw new RuntimeError(expr.parent, "Expected " + function.arity() + " argumetns but got " + arguments.size() + ".");
        }
    ...
    void executeBlock(List<Stmt> statments, Environment environemnt) {
